...
console.log(check(Driver1.ID, Airplane1.ID, 1));
console.log(check(Driver2.ID, Car2.ID, 2));
console.log(check(Driver3.ID, Car3.ID, 3));
console.log(check(Pilot1.ID, Car1.ID, 4));
console.log(check(Pilot2.ID, Airplane1.ID, 5));
